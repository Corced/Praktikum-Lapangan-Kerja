...
<body class="bg-gray-100">
    <div class="container mx-auto p-6 max-w-2xl">
        ...
        <form action="{{ route('layanans.store') }}" method="POST" class="bg-white p-6 rounded shadow-md">
            @csrf
            ...
            <div class="mb-4">
                ...
                <p class="text-sm text-gray-500 mt-1">Contoh: Apa itu Medical Checkup?</p>
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="match_type" id="match_type" required
                    ...
                    <option value="exact">Tepat Sama</option>
